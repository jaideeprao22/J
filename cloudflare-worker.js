/* ============================================================
   ...
   Deploy at: Workers & Pages → contact-form
   Add env variable: RESEND_API_KEY = re_xxxxxxxxxxxx
   ============================================================ */

const ALLOWED_ORIGIN = 'https://jaideeprao.com';
const FROM_EMAIL     = 'contact@jaideeprao.com';
// Set CONTACT_TO_EMAIL as an env variable in the Worker (kept out of source/public repo).
// Falls back to the role address below if the env var is not set.
const TO_EMAIL       = 'contact@jaideeprao.com';
          ...
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#222;">
            ...
            <table style="width:100%;border-collapse:collapse;margin:16px 0;">
              <tr style="background:#f9f9f9;">
                <td style="padding:10px 12px;font-weight:600;width:90px;color:#555;">Name</td>
                <td style="padding:10px 12px;">${esc(name)}</td>
              </tr>
              <tr>
                <td style="padding:10px 12px;font-weight:600;color:#555;">Email</td>
                <td style="padding:10px 12px;"><a href="mailto:${esc(email)}" style="color:#7c5cff;">${esc(email)}</a></td>
              </tr>
              <tr style="background:#f9f9f9;">
                <td style="padding:10px 12px;font-weight:600;color:#555;">Subject</td>
                <td style="padding:10px 12px;">${esc(subject || '—')}</td>
              </tr>
            </table>
